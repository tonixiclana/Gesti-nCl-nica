		  ...
		  <div class="btn-group btn-group-justified">
            <div class="btn-group">
                  <a type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    Especialista <span class="caret"></span>
                  </a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a onclick="cargar('Admin/crearEspecialista')">Crear especialista</a></li>
                    <li><a onclick="cargar('Admin/verEspecialista')">Buscar especialista</a></li>
                  </ul>
            </div>
          </div>
        </div>
