...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="stylesheet" href="http://localhost/calendario_ci/css/estilos.css" />
    ...
    <script type="text/javascript" src="http://localhost/calendario_ci/js/funciones.js"></script>
</head>
